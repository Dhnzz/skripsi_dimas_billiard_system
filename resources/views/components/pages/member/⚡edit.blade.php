...
new #[Layout('layouts.app', ['title' => 'Edit Member', 'breadcrumbs' => [['title' => 'Manajemen Member', 'url' => '/owner/member'], ['title' => 'Edit Member', 'url' => '#']]])] class extends Component {
    use WithFileUploads;
    ...
    public function mount($id)
    {
        ...
        $this->existingAvatar = $member->avatar;
    }
    ...
    public function save()
    {
        ...
        if ($this->avatar) {
            ...
            $member->avatar = $this->avatar->store('avatars', 'public');
        } elseif ($this->existingAvatar === null && $member->avatar) {
        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Edit Informasi Member</h4>
                        </div>
                    </div>
                    <div class="card-body">
