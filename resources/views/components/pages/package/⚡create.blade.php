...
new #[Layout('layouts.app', ['title' => 'Tambah Paket', 'breadcrumbs' => [['title' => 'Manajemen Paket', 'url' => '/owner/package'], ['title' => 'Tambah Paket', 'url' => '#']]])] class extends Component {
    ...
    {
        // Reset price dan duration ketika tipe berubah ke loss
        if ($this->type === 'loss') {
            $this->price = '';
            $this->duration_hours = '';
        }
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="header-title">
                            <h4 class="card-title">Informasi Paket Baru</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
