...
new #[Layout('layouts.app', ['title' => 'Edit Tarif', 'breadcrumbs' => [['title' => 'Manajemen Tarif', 'url' => '/owner/pricing'], ['title' => 'Edit Tarif', 'url' => '#']]])] class extends Component {
    ...
    public function mount($id)
    {
        ...
        $this->price_per_hour = (int) $pricing->price_per_hour;
        $this->start_time = $pricing->start_time ?? '';
        $this->end_time = $pricing->end_time ?? '';
        $this->is_active = $pricing->is_active;
        $this->apply_days = $pricing->apply_days ?? [];
    }
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="header-title">
                            <h4 class="card-title">Edit Informasi Tarif</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    @foreach ($dayOptions as $value => $label)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                ...
                                                value="{{ $value }}"
                                                @if(in_array($value, $apply_days ?? [])) checked @endif>
