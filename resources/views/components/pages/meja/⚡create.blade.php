...
new #[Layout('layouts.app', ['title' => 'Tambah Meja', 'breadcrumbs' => [['title' => 'Manajemen Meja', 'url' => '/owner/meja'], ['title' => 'Tambah Meja', 'url' => '#']]])] class extends Component {
    public $table_number = '';
    public $name = '';
    public $description = '';
    ...
    public function save()
    {
        ...
        session()->flash('success', 'Data meja berhasil ditambahkan!');
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Informasi Meja Baru</h4>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-check form-switch mt-2">
                                        ...
                                        <label class="form-check-label" for="is_active">
                                            ...
                                            @else
                                                <span class="text-danger fw-medium">Nonaktif</span>
                                            @endif
                                        </label>
                                    </div>
                                </div>
