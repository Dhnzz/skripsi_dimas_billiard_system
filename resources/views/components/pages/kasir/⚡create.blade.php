...
new #[Layout('layouts.app', ['title' => 'Tambah Kasir', 'breadcrumbs' => [['title' => 'Manajemen Kasir', 'url' => '/owner/kasir'], ['title' => 'Tambah Kasir', 'url' => '#']]])] class extends Component {
    use WithFileUploads;
    ...
    public function save()
    {
        ...
        session()->flash('success', 'Data kasir berhasil ditambahkan!');
        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Informasi Kasir Baru</h4>
                        </div>
                    </div>
                    <div class="card-body">
