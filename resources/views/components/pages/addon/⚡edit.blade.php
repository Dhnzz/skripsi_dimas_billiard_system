...
new #[Layout('layouts.app', ['title' => 'Edit Addon', 'breadcrumbs' => [['title' => 'Manajemen Addon', 'url' => '/owner/addon'], ['title' => 'Edit Addon', 'url' => '#']]])] class extends Component {
    use WithFileUploads;
    ...
    public function save()
    {
        ...
        $addon->category = $this->category;
        $addon->price = $this->price;
        $addon->stock = $this->stock !== '' ? $this->stock : null;
        $addon->is_active = $this->is_active;
        ...
        if ($this->image) {
            ...
            $addon->image = $this->image->store('addons', 'public');
        } elseif ($this->existingImage === null && $addon->image) {
            // User menghapus gambar tanpa mengunggah yang baru
            if (Storage::disk('public')->exists($addon->image)) {
                Storage::disk('public')->delete($addon->image);
            }
            $addon->image = null;
        }
        ...
        session()->flash('success', 'Data addon berhasil diperbarui!');
        ...
        <div class="row">
                        ...
                        <div class="form-group">
                            <div class="profile-img-edit position-relative d-flex justify-content-center mb-3">
                                ...
                                @elseif ($existingImage)
                                    <img src="{{ Storage::url($existingImage) }}" alt="addon-pic" class="rounded"
                                        style="object-fit: cover; width: 150px; height: 150px;">
                                @else
                            ...
                            <div class="img-extension mt-3">
                                ...
                                @if ($existingImage || $image)
                                    <button type="button" wire:click="removeImage"
                                        ...
                                        <i class="fa-solid fa-trash-can me-1"></i> Hapus Gambar
                                    </button>
                                @endif
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Edit Informasi Addon</h4>
                        </div>
                    </div>
                    <div class="card-body">
