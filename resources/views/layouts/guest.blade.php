...
<head>
    ...
    <title>Swiss 18 Pool | Login</title>
...
<body class=" " data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
        ...
        <section class="login-content">
            <div class="row m-0 align-items-center bg-white vh-100">
                ...
                <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
                    <img src="{{ asset('dashboard_asset/images/auth/01.png') }}"
    ...
    <script src="{{ asset('dashboard_asset/js/core/libs.min.js') }}"></script>
    ...
    <!-- App Script -->
    <script src="{{ asset('dashboard_asset/js/core/libs.min.js') }}" defer></script>
